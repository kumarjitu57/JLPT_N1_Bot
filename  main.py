...
current_quiz_type = {} # track which quiz user is currently taking
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "💬 Or just chat with me naturally about JLPT!"
    )
...
def main():
    ...
    print("🤖 JLPT N1 Bot Running with interactive multiple-choice quizzes + natural conversation...")
    app.run_polling()
